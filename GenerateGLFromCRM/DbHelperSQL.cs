...
namespace AutoIssueAndShip
{
    /// <summary>
    /// 数据访问抽象基础类
    /// Copyright (C) TimeAndExpensePlug 
    /// </summary>
    public class DbHelperSQL
    {
        ...
        public DbHelperSQL()
        {
            connectionString = System.Configuration.ConfigurationManager.AppSettings["SQLConnString"];
        }
        ...
        public DataTable GetDataTableBySql(string SQLString)
        {
